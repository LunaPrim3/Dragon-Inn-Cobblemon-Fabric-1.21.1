...
public class WormholeModel<T extends Wormhole> extends SinglePartEntityModel<T> {
    public static final EntityModelLayer WORMHOLE = new EntityModelLayer(Identifier.of(DragonInnCobblemonMod.MOD_ID, "wormhole"), "main");
    ...
    @Override
    public void setAngles(Wormhole entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
